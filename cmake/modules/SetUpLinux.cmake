...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL Clang)
  ...
  set(CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS "${CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS}")
  set(CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS "${CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS}")
  if(${CMAKE_SHARED_LINKER_FLAGS} MATCHES ".*fsanitize=address.*")
    message(WARNING "By default, ROOT is built with the linker flag '--no-undefined'. Since address sanitizer is in use, this is disabled.")
